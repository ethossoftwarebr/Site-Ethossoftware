...
| server | Express 5 + Drizzle ORM + Postgres + Passport | 5000 (prod, single port) | [server](./server/CLAUDE.md) |
| shared | Drizzle schema + Zod validators (TypeScript) | - | [shared](./shared/CLAUDE.md) |
